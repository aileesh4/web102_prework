...
let displayStr = `A total of $${totalAmountRaised.toLocaleString()} has been raised for 
    ${GAMES_JSON.length.toLocaleString()} games. 
    Currently, ${totalUnfunded} ${totalUnfunded > 1 ? 'games' : 'game'} remains unfunded. 
